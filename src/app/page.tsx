...
export default function Home() {
  ...
  return <>
    <div className="page-heading"><div><p className="eyebrow">Panel institucional</p><h1>Gestión de Procesos</h1><p>Consulta, actualiza y controla los procesos de Rebagliati.</p></div><Link className="button button-primary" href="/biblioteca">Explorar procesos <ArrowRight size={16}/></Link></div>
    <div className="pilot-banner"><Info size={17}/><span><strong>Entorno piloto.</strong> Los registros visibles sirven para validar la experiencia; la estructura se guarda en la base de datos del portal y enlaza los archivos maestros de Drive.</span></div>
