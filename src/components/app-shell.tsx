...
import { BarChart3, Bell, BookOpen, ChevronDown, FileText, FolderKanban, GitBranch, Home, Menu, PanelLeftClose, PanelLeftOpen, Search, Settings, ShieldCheck, X } from "lucide-react";
