...
export const subareas: Subarea[] = [
  ...
  { code:"MKT-S01", areaCode:"MKT", name:"Community Manager", description:"Planificación, publicación y monitoreo de redes sociales.", owner:"Community Manager", flow:["Planificar calendario","Preparar contenido","Aprobar publicación","Publicar y monitorear"], source:"Drive" },
  { code:"MKT-S02", areaCode:"MKT", name:"Community", description:"Atención de comunidad, mensajes y derivación de oportunidades.", owner:"Responsable de Comunidad", flow:["Recibir interacción","Clasificar consulta","Responder o derivar","Registrar resultado"], source:"Drive" },
  { code:"MKT-S03", areaCode:"MKT", name:"Diseño y audiovisual", description:"Producción de piezas gráficas, video y recursos de campaña.", owner:"Responsable de Diseño", flow:["Recibir brief","Diseñar propuesta","Revisar pieza","Entregar arte final"], source:"Drive" },
  { code:"MKT-S04", areaCode:"MKT", name:"Tráfico y pauta digital", description:"Configuración, optimización y medición de campañas pagadas.", owner:"Trafficker Digital", flow:["Recibir campaña","Configurar pauta","Monitorear rendimiento","Optimizar y reportar"], source:"Drive" },
