...
export const areas: Area[] = [
  { code: "COM", name: "Comercial", description: "Captación, seguimiento y conversión de oportunidades.", owner: "Jefatura Comercial", processCount: 4, approved: 1, color: "#00A7EB" },
...
export const subareas: Subarea[] = [
  ...
  { code:"LOG-S01", areaCode:"LOG", name:"Compras y abastecimiento", description:"Adquisición de bienes y servicios para la operación.", owner:"Jefatura de Logística", flow:["Recibir solicitud","Cotizar","Aprobar compra","Recibir y dar conformidad"], source:"Propuesta" },
  { code:"LOG-S02", areaCode:"LOG", name:"Inventario y activos", description:"Registro, asignación y control de bienes institucionales.", owner:"Responsable de Almacén", flow:["Registrar ingreso","Codificar activo","Asignar responsable","Controlar inventario"], source:"Propuesta" },
  { code:"LOG-S03", areaCode:"LOG", name:"Servicios generales", description:"Mantenimiento, infraestructura y servicios de apoyo.", owner:"Coordinación Administrativa", flow:["Reportar necesidad","Programar atención","Ejecutar servicio","Validar conformidad"], source:"Propuesta" },
