...
join (values
  ...
  ('GER','GER-S05','Asistentes de Gerencia','Supervisión transversal, seguimiento de acuerdos, control de incidencias y reportes ejecutivos a Gerencia.','Asistente de Gerencia',array['Solicitar información','Verificar cumplimiento','Gestionar incidencias','Reportar a Gerencia']::text[],'drive'),
