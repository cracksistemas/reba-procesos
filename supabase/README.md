...
3. Aplica con `npx supabase db push`.
   Incluye `202609170001_workspace_persistence.sql`, que habilita guardado
   compartido de procesos, tareas y lienzos editables. También puedes ejecutar
   esa migración completa en el SQL Editor de Supabase si no usarás la CLI.
